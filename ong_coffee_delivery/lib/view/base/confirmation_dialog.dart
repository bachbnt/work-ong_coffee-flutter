...
class ConfirmationDialog extends StatelessWidget {
  ...
  ConfirmationDialog({@required this.icon, this.iconSize = 50, this.title, @required this.description, @required this.onYesPressed, this.isLogOut = false, this.hasCancel = true});
