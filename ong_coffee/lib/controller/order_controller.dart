import 'package:ongcoffee/data/api/api_checker.dart';
import 'package:ongcoffee/data/model/body/place_order_body.dart';
import 'package:ongcoffee/data/model/response/distance_model.dart';
import 'package:ongcoffee/data/model/response/order_details_model.dart';
import 'package:ongcoffee/data/model/response/order_model.dart';
import 'package:ongcoffee/data/model/response/response_model.dart';
import 'package:ongcoffee/data/model/response/restaurant_model.dart';
import 'package:ongcoffee/data/model/response/timeslote_model.dart';
